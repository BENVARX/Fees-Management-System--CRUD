...
$query = "SELECT 
    ...
    SUM(others_fee) AS total_others_fee
          FROM paidfees
          INNER JOIN entries ON paidfees.rollno = entries.rollno
...
if ($result) {
    ...
    echo "<h2 style='margin-left:400px;margin-top:150px;color:grey;font-family:poppins;'>Paid Fees for $department Department in batch $batch:</h2>";
