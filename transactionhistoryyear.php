...
<html>
<head>
    <title>Search Transaction History year</title>
...
<body>
    ...
    <h1>Search Transaction History Using Year</h1>
    <form method="post">
    
      
        <div class="label2">
        <input style="border-radius:15px;border:2px solid black;width: 650px;height: 20px;padding:7px;" type="text" id="search_year" name="search_year" placeholder="YYYY" required><br><br>
       </div>
       <div class="submit">
    ...
    if (!empty($search_date) || !empty($search_month) || !empty($search_year)) {
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<p class='results'>No transactions found for the specified year.</p>";
        }
