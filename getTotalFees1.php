...
$query = "SELECT 
    ...
    SUM(others_fee) AS total_others_fee
          FROM feesreduction
          INNER JOIN entries ON feesreduction.rollno = entries.rollno
...
if ($result) {
    ...
    echo "<h2 style='margin-left:400px;margin-top:150px;color:grey;font-family:poppins;'>Original Feess for $department Department in batch $batch:</h2>";
