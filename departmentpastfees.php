...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    if (isset($_GET["department"]) && !empty($_GET["department"]) &&
        ...
        // Prepare SQL query
        $sql = "SELECT entries.first_name, entries.last_name, entries.current_year, pastfees.rollno, pastfees.admission_fee, pastfees.tuition_fee, pastfees.book_fee, pastfees.uniform_fee, pastfees.hostel_fee, pastfees.caution_deposit_hostel, pastfees.transport_fee, pastfees.examination_fee, pastfees.library_fee, pastfees.placement_training_fee, pastfees.others_fee, pastfees.total
                FROM pastfees
                JOIN entries ON pastfees.rollno = entries.rollno
        ...
        echo "<table border='1'>";
        echo "<tr style='background-color:black;'><th>Name</th><th>Current Year</th><th>Rollno</th><th>Admissionfee</th><th>Tuitionfee</th><th>Bookfee</th><th>Uniformfee</th><th>Hostelfee</th><th>Cautiondeposithostel</th><th>Transportfee</th><th>Examinationfee</th><th>Libraryfee</th><th>Placementfee</th><th>Otherfee</th><th>Total Amount</th></tr>";
        $total_amount = 0;
